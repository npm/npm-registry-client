...
function regRequest (method, uri, options, cb_) {
  ...
  this.attempt(function (operation) {
    makeRequest.call(self, method, where, what, options.etag, nofollow, authed
...
function makeRequest (method, where, what, etag, nofollow, authed, cb_) {
  var cb = once(cb_)
